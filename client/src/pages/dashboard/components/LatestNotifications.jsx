...
const LatestNotifications = ({ notifications, loading }) => {
  if (loading) {
    return (
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm p-6">
      <div className="flex justify-between items-center mb-4">
        ...
        <Link to="/notifications" className="text-sm text-primary-600 hover:text-primary-800 flex items-center">
          View All
        ...
        <div className="space-y-4">
          {notifications.slice(0, 5).map((notification) => (
            <div 
              ...
              className={`flex items-start space-x-3 p-3 rounded-md ${notification.read ? '' : 'bg-primary-50 border border-primary-100'}`}
            >
